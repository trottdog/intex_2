...
Run `py -3 scripts/run_phase1_eda.py` to regenerate the reports and figures.

## Deliverables Produced

- Global profiling notebook: `ml-pipelines/01_global_data_profiling.ipynb`
- Null and missingness report: `reports/tables/phase1_missingness_report.csv`
- Category distribution report: `reports/tables/phase1_categorical_report.csv`
- Date coverage report: `reports/tables/phase1_time_coverage_summary.csv` and `reports/tables/phase1_time_coverage_monthly.csv`
- Label feasibility report: `reports/tables/phase1_label_feasibility_report.csv`
- Visual EDA artifacts: `reports/figures/phase1/`
