    ...
    >
            ...
            <div className="mfa-actions-row">
              {status.isTwoFactorEnabled ? (
                ...
                <button
                  ...
                  type="button"
                  disabled={saving}
                  onClick={() => void runAction(generateTwoFactorSetup, 'Authenticator setup key generated.')}
                >
                  {saving ? 'Generating...' : 'Generate setup key'}
                </button>
              ) : null}
            </div>
          </div>
      ...
      {status ? (
        ...
        >
          {status.needsSetup ? (
            <div className="stack-list">
              <p>Generate a setup key to load the QR code and manual authenticator secret for this account.</p>
              <div>
                <button
                  className="primary-button"
                  type="button"
