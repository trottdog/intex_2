...
export const directorPhotos: DirectorPhoto[] = [
  { src: '/images/directors/Apple-Lanman_lighthouse.jpeg', name: 'Apple Lanman' },
  { src: '/images/directors/KalliWilson.jpg', name: 'Kalli Wilson' },
  { src: '/images/directors/Lance-Platt-Headshot-scaled.jpg', name: 'Lance Platt' },
  { src: '/images/directors/Russell-Osguthorpe_lighthouse.jpg', name: 'Russell Osguthorpe' },
  { src: '/images/directors/StevenTwoCleanedUp.jpeg', name: 'Steven' },
  { src: '/images/directors/candace.jpeg', name: 'Candace' },
  { src: '/images/directors/julie.jpg', name: 'Julie' },
]
